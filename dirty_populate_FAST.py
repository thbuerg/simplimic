                ...
                sql = 'INSERT INTO simplimic_FT (' \
                      ...
                      ') VALUES {}'.format(
                        ', '.join(['(%s, %s, %s,'
                                   ...
                                   '%s, %s, %s,'
                                   '%s, %s, %s,'
                                   '%s, %s, %s)'] * item_df.shape[0])
                    )
                params = []
                for i in range(0, item_df.shape[0]):
                    r = item_df.iloc[i]
                    params.extend([p, a, i, itm,
                                   r['CHARTTIME'],
                                   r['STORETIME'],
                                   r['CGID'], r['VALUE'], r['VALUENUM'],
                                   r['VALUEUOM'], r['WARNING'], r['ERROR'],
                                   r['RESULTSTATUS'], r['STOPPED']])
